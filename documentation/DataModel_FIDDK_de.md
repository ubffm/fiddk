...
`dcterms:alternative` | literal | min 0, max unbounded | Any alternative title of the CHO including abbreviations or translations that may not be exact. `<dcterms:alternativexml:lang=“en”>Eight weeks: a novel</dcterms:alternative>` | Alternative Titel, Titelzusätze, Untertitel, übersetzte Titel; Sprachangabe sofern bekannt
...
`rdau:P60813` | literal or reference to Agent | min 0, max unbounded | "has lightning designer" - Relates a resource to an agent who contributes to a resource by designing and creating lighting components. | Lichtdesigner_in / Beleuchter_in
